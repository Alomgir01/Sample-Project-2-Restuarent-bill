...
void printMeals()
{
    ...
    printf(" \t\t\t MEALS\t\t\tPRICE:\n");
    printf(" \t\t\t \22*******************************\22\n");
    printf(" \t\t\t 1- Fish and Chips\tTk15.80\n");
    printf(" \t\t\t 2- Spaghetti\t\tTk10.50\n");
    printf(" \t\t\t 3- T-Bone Steak\tTk19.00\n");
    printf(" \t\t\t 4- Chicken Chop\tTk14.00\n");
    printf(" \t\t\t 5- Chicken Maryland\tTk12.00\n");
    printf(" \t\t\t 6- Red Lobster\t\tTk22.00\n");
    printf(" \t\t\t 7- Seafood Platter\tTk16.00\n");
    printf("\n");
}
void orderMeals()
{
